...
*상승장*  
- **기본 롱**: 15m 눌림 후 반등(또는 1~2틱 조정) 확인 시  
- **보조 롱(돌파)**: 눌림 없거나 즉시 상승 구간이면 15m 고점 돌파 시  
- **단기 숏(조정)**: 과매수(RSI>70)+둔화+거래량 감소 시  
- **절대 숏 금지**: 강한 추세(ADX>25 등) 구간에서는 숏 금지  

*하락장*  
- **기본 숏**: 15m 되돌림 후 하락 재개 시  
- **보조 숏(돌파)**: 되돌림 없거나 즉시 하락 구간이면 15m 저점 이탈 시  
- **단기 롱(반등)**: 과매도(RSI<30)+MACD 반등+거래량 급증 시  
- **절대 롱 금지**: 강한 추세 구간에서는 롱 금지  

*횡보장*  
- **단기 롱(반등)**: RSI<30 반등, BB 하단 터치 + 거래량 급등  
- **단기 숏(조정)**: RSI>70 조정, BB 상단 터치 + 거래량 급감  
- **돌파 진입**: 수렴 구간 돌파 확인 시  
- 그 외에는 **관망**
